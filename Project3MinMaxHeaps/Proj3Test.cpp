...
void test3()
{
	...
	result = q->getMin();
	std::cout << "   The smallest city in California is: " << result << std::endl;
	result = q->get25();
	std::cout << "   The 25th percentile city in California is: " << result << std::endl;
	result = q->get50();
	std::cout << "   The median city in California is: " << result << std::endl;
	result = q->get75();
	std::cout << "   The 75th percentile city in California is: " << result << std::endl;
	result = q->getMax();
	std::cout << "   The largest city in California is: " << result << std::endl;
	...
	result = q->getMin();
	std::cout << "   The smallest city in the U.S. is: " << result << std::endl;
	result = q->get25();
	std::cout << "   The 25th percentile city in the U.S. is: " << result << std::endl;
	result = q->get50();
	std::cout << "   The median city in the U.S. is: " << result << std::endl;
	result = q->get75();
	std::cout << "   The 75th percentile city in the U.S. is: " << result << std::endl;
	result = q->getMax();
	std::cout << "   The largest city in California is: " << result << std::endl;
